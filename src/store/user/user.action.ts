...
export const signInSuccess = withMacther((user: UserData): SignInSuccess => 
...
export const signUpSuccess = withMacther((user: UserData, additionalDetails: AdditionalInformation): SignUpSuccess => 
